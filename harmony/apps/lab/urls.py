...
urlpatterns = patterns(
    ...
    url(r'^exercise/(?P<group_name>\w+(?:/\D\w*)?)/(?P<exercise_name>\d+)$', ExerciseView.as_view(), name="exercise"),
    url(r'^exercise/(?P<group_name>\w+(?:/\D\w*)?)$', ExerciseView.as_view(), name="exercise-group"),
